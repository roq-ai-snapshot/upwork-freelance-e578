...
import { getSupportTickets } from 'apiSdk/support-tickets';
...
import { SupportTicketListPage as ShowCaseList } from 'pages/support-tickets';
...
function DashboardPage() {
  ...
  const supportTicketStat = useSWR<PaginatedInterface<SupportTicketInterface>>(
    () => `/support-tickets`,
    () => getSupportTickets({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: supportTicketStat?.data?.totalCount,
      isLoading: supportTicketStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`support-tickets`} passHref legacyBehavior>
                  <Button
