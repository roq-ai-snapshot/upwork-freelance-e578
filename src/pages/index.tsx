  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of freelancing with Upwork freelancer site - A platform designed for both clients and freelancers to connect, collaborate, and succeed."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of freelancing with Upwork freelancer site - A platform designed for both clients and freelancers to connect, collaborate, and succeed.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Client" type="client" abilities={appConfig.ownerAbilities} />
