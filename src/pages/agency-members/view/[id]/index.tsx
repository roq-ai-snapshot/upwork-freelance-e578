...
import { getAgencyMemberById } from 'apiSdk/agency-members';
import { AgencyMemberInterface } from 'interfaces/agency-member';

function AgencyMemberViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('agency_member', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/agency-members/edit/${id}`} passHref legacyBehavior>
                    <Button
