...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project.create.create': {
    roles: ['freelancer', 'agency-owner', 'agency-team-member', 'support-staff'],
    key: 'project',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['client'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['client', 'freelancer', 'agency-owner', 'agency-team-member', 'support-staff'];
