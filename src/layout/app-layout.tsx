...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['client', 'freelancer', 'agency-owner', 'agency-team-member', 'support-staff'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Agencies', path: '/agencies', entity: 'agency', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Agency Members',
      path: '/agency-members',
